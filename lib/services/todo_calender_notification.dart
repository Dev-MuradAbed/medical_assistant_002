...
import '../screens/doctor_screens/todo_screens/notification_screen.dart';





class CalenderNotificationHelper {
  ...
  CalenderNotificationHelper(this.context);
  ...
  cancleNotification(Calender task) async {
  ...
  scheduledNotification(int hour, int minutes, Calender task) async {
    await flutterLocalNotificationsPlugin.zonedSchedule(
      task.id!,
      task.title,
      task.note,
      _nextInstanceOfTenAM(
          hour, minutes, task.repeat!, task.date!),
